...
class PaymentController extends Controller
{
    ...
    public function initiatePayment(Request $request)
    {
        ...
        $userSecretKey = '0fkoyqfl-uabe-et78-c31c-9x8o85wuacsk';
        $categoryCode = 'dvwbf4m9';

        // dd($userSecretKey, $categoryCode);
        ...
        if ($response->successful() && isset($response->json()[0]['BillCode'])) {
            ...
            Payment::create([
                ...
                'amount' => $amount,
                'payment_status' => 'Success', // Mark as pending until confirmation
