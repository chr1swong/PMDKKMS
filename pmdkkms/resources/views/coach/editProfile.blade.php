...
<body>
    ...
    <div class="profile-container">
        ...
        <div class="profile-sidebar">
            ...
            <form action="{{ route('coach.updateProfilePicture') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
        ...
        <form class="profile-details" action="{{ route('coach.updateProfile') }}" method="POST">
            @csrf
            <div>
            ...
            <div>
                ...
                <input type="text" id="role" value="Coach" disabled>
            </div>
            ...
            <div style="margin-top: 15px;">
                <a href="{{ url('coach/profile') }}" class="btn-cancel">Cancel</a>
            </div>
            <div style="margin-top: 15px;">
        ...
        <form class="profile-details" action="{{ route('coach.changePassword') }}" method="POST">
        @csrf
        <div class="full-width">
