...
Route::middleware('auth')->group(function () {
    Route::get('/archer/dashboard', [AccountController::class, 'showArcherDashboard'])->name('archer.dashboard');
    Route::get('/coach/dashboard', [AccountController::class, 'showCoachDashboard'])->name('coach.dashboard');
    Route::get('/committee/dashboard', [AccountController::class, 'showCommitteeDashboard'])->name('committee.dashboard');
});
